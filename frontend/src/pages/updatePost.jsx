...
export default function UpdatePost() {
    ...
    useEffect(() => {
        const fetchArticleForUpdate = async () => {
            try {
                setLoading(true);
                const response = await api.get(`/articles/get/update/${slug}`);
                ...
                // Parse and set content chunks
                const parsedContent = JSON.parse(article.content);
                setChunks(parsedContent);
                
                // Set publish data
                setPublishData(prev => ({
                    ...prev,
                    category: article.category_id?.toString() || '',
                    currentImageUrl: article.featured_image ? `http://127.0.0.1:5050/storage/${article.featured_image}` : null
                }));
                
                setError(null);
            } catch (err) {
                console.error('Error fetching article for update:', err);
    ...
    const handleUpdateArticle = async () => {
        ...
        try {
            ...
            const response = await api.post(`/articles/update/${articleId}`, formData, {
                headers: {
            ...
            const updatedSlug = response.data.data.article.slug;
            navigate(`/article/${updatedSlug}`);
        } catch (error) {
    ...
    // Render chunk content (same as create page)
        ...
        <>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Make changes to your article and update it.</p>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-4">
                            <button
                                onClick={() => navigate('/dashboard')}
                                className="px-6 py-3 text-gray-700 border border-gray-300 hover:bg-gray-50 rounded-lg font-medium transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                    ...
                    <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        <div className="p-6">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-2xl font-bold text-gray-900">Update Article</h2>
                                <button
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {publishData.currentImageUrl && !publishData.featuredImage && (
                                        <div className="mb-3">
                                            <p className="text-sm text-gray-600 mb-2">Current image:</p>
                                            <img
                                                src={publishData.currentImageUrl}
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-600">
                                                        <span className="font-medium text-blue-600">
                                                            {publishData.currentImageUrl ? 'Upload new image' : 'Click to upload'}
